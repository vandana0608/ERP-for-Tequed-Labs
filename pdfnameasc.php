...
$result = mysqli_query($connString, "SELECT name, college, yearofstudy, branch, courseopted, trainer, totalfees FROM studentdetails ORDER BY name") or die("database error:". mysqli_error($connString));
