...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 27, 2020 at 10:27 AM
...
('root', '[{\"db\":\"login\",\"table\":\"medicinelist\"},{\"db\":\"login\",\"table\":\"userdetails\"},{\"db\":\"testdb\",\"table\":\"logintable\"},{\"db\":\"testdb\",\"table\":\"login\"}]');
...
('root', '2020-01-18 06:10:40', '{\"Console\\/Mode\":\"collapse\"}');
...
-- Database: `tlogin`
--
CREATE DATABASE IF NOT EXISTS `tlogin` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `tlogin`;
