...
$result = mysqli_query($connString, "SELECT name, college, yearofstudy, branch, courseopted, trainer, totalfees FROM studentdetails ORDER BY trainer") or die("database error:". mysqli_error($connString));
